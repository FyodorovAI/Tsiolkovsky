...
async def test_update_tool(tool_fixture):
    ...
    updated_tool = await Tool.update_in_db(tool_id, update)
...
async def test_delete_tool(tool_fixture):
    ...
    deletion_result = await Tool.delete_in_db(tool_id)
